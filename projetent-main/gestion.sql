...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 20 fév. 2024 à 16:35
...
INSERT INTO `piecejointe` (`id_piece_jointe`, `contenu`, `nom`, `type`, `intervention_id`, `chemin_stockage`, `nom_fichier`) VALUES
(1, NULL, 'passSuggest.txt', 'text/plain', 1, NULL, NULL),
(2, NULL, 'ListeBDS.docx', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 2, NULL, NULL),
(3, NULL, 'Entré.docx', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 4, NULL, NULL),
(4, NULL, 'Lancer une chaîne de podcast est une excellente idée.docx', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 4, NULL, NULL),
(5, NULL, 'ListeBDS.docx', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 4, NULL, NULL),
(6, NULL, 'Tournoi d\'echec.pdf', 'application/pdf', 5, NULL, NULL),
(7, NULL, 'WaFO Aristide_2.pdf', 'application/pdf', 7, NULL, NULL),
(8, NULL, 'convention.pdf', 'application/pdf', 7, NULL, NULL),
(9, NULL, 'TOURNOI ECHEC.docx', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 8, NULL, NULL),
(10, NULL, '2021i074 A2.pdf', 'application/pdf', 9, NULL, NULL),
(11, NULL, 'TOURNOI ECHEC.docx', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 11, NULL, NULL),
(12, NULL, 'convention (1).pdf', 'application/pdf', 12, NULL, NULL),
(13, NULL, 'Terme de Reference sur le lancement des activites du bds.pdf', 'application/pdf', 20, NULL, NULL),
(14, NULL, 'IInvitation directeur SJI.pdf', 'application/pdf', 21, NULL, NULL),
(15, NULL, 'feuille de matchF.pdf', 'application/pdf', 21, NULL, NULL),
(16, NULL, 'TDR BDS.pdf', 'application/pdf', 21, NULL, NULL),
(17, NULL, 'Terme de Reference sur le lancement des activites du bds.pdf', 'application/pdf', 21, NULL, NULL),
(18, NULL, 'Proposition de solution.pdf', 'application/pdf', 21, NULL, NULL),
(19, NULL, 'tassi.pdf', 'application/pdf', 22, NULL, NULL),
(20, NULL, 'correction psychologie.pdf', 'application/pdf', 22, NULL, NULL),
(21, NULL, 'Invitation aux directeurs.pdf', 'application/pdf', 22, NULL, NULL),
(22, NULL, 'Screenshot (86).png', 'image/png', 24, NULL, NULL),
(23, NULL, 'Lettre de demande d\'abonnement Canal.pdf', 'application/pdf', 28, NULL, NULL);
...
--
-- Déchargement des données de la table `piecesjointes_email`
--

INSERT INTO `piecesjointes_email` (`id_piece_jointe_email`, `contenu`, `nom`, `type`, `email_id`, `email_message_id`) VALUES
(1, NULL, 'Lancer une chaîne de podcast est une excellente idée.docx', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 4, 2),
(2, NULL, 'bourse INSA.docx', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 10, 3),
(3, NULL, 'proforma fronton.pdf', 'application/pdf', 14, 4),
(4, NULL, 'WaFO Aristide_2.pdf', 'application/pdf', 22, 6),
(5, NULL, '2021i074 A2.pdf', 'application/pdf', 34, 9),
(6, NULL, 'bdb71500e0d1a267a37b487a266d68c2-presentation-can-2024.pdf', 'application/pdf', 71, 17),
(7, NULL, 'CAN 2024.pdf', 'application/pdf', 71, 17),
(8, NULL, 'Carrousel LinkedIn Entreprise IT ou Tech Professionnel Géométrique Nuances de Verts.pdf', 'application/pdf', 71, 17);
...
CREATE TABLE `reponse` (
  ...
  `date_creation_rep` date DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL,
  `intervention_id` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Déchargement des données de la table `sous_intervention`
--

INSERT INTO `sous_intervention` (`id_sous_intervention`, `description`, `id_categorie`, `id_departement`) VALUES
(1, 'Compte egare', 1, 1),
(2, 'Creation de compte', 1, 1),
(3, 'Reinitialisation du mot de passe institutionnelle', 2, 1),
(4, 'Reinitialisation du mot de passe PortailC', 2, 1),
(5, 'Releve de note annuel', 3, 2),
(6, 'Recu de la scolarite', 3, 3);
...
INSERT INTO `user` (`id_user`, `email`, `login`, `nom`, `password`, `prenom`, `id_role`, `subject`) VALUES
(1, 'jerry.wafo@institutsaintjean.org', 'root', 'root', '$2a$10$cxh759PUlqCFhOQ1QUX8WOjS4yASa7/L2E64esFWbG539.U7h.Doy', 'root', 2, NULL),
(3, 'wafokamguejerry@gmail.com', 'wafokamguejerry@gmail.com', 'rootu', '$2a$10$Go.9Qy3S6A4DxuHELzdntO2l8Nj28G7MPG19KOpm/4baW7yjYiVH2', 'rootu', 1, 'wafokamguejerry@gmail.com&student'),
(5, 'nounamoestrella@gmail.com', 'nounamoestrella@gmail.com', 'nounamo', '$2a$10$95jge4LnjthGBE5Fh9Bzxu10ZVjsHuqtpFQDvGKQ8ydGlzOAtDUee', 'estrella', 1, 'jerry.wafo@institutsaintjean.org&User'),
(6, 'etiennenkot2@gmail.com', 'etiennenkot2@gmail.com', 'etiennenkot2@gmail.com', '$2a$10$GZsYPBIDCsv3giqOzTpjcueAV3DBn41qpY1qgtkR9prb6FiErmhMa', 'etiennenkot2@gmail.com', 2, 'wafokamguejerry@gmail.com&Admin'),
(7, 'belomjordan@gmail.com', 'belom', 'belom', '$2a$10$PqteA3kN5EQQkUrTq.Ipc.2YDxkStZDEmS0CRFqoFmr1sxzBDL9UG', 'jordan', 2, 'belomjordan@gmail.com&user');
...
INSERT INTO `utilisateur` (`code`, `email`, `login`, `nom_personnel`, `password`, `prenom_personnel`, `departement_id`, `mot_de_passe`) VALUES
(2, 'wafokamguejerry@gmail.com', 'wafokamguejerry@gmail.com', 'root', NULL, 'root', 2, NULL),
(1, 'wafokamguejerry@gmail.com', 'etiennenkot2@gmail.com', 'etiennenkot2@gmail.com', NULL, 'etiennenkot2@gmail.com', 2, NULL),
(4, 'belomjordan@gmail.com', 'belom', 'belom', NULL, 'jordan', 2, NULL);
...
--
ALTER TABLE `piecesjointes_email`
  MODIFY `id_piece_jointe_email` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `sous_intervention`
  MODIFY `id_sous_intervention` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
